...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <form v-on:submit.prevent='signIn'>
      ...
      <input type="email" id="email" class="fadeIn second" name="email" placeholder="Email" v-model="email" required> 
      <input type="password" id="password" class="fadeIn third" name="password" placeholder="Contraseña" v-model="password" required> 
